...
class _PainterState extends State<Painter> {
  ...
  void didChangeDependencies() {
    ...
    switch (widget.painterController.mode) {
      case 'comic':
        {
          widget.painterController._pathHistory.add(Offset(1, height / 2));
          widget.painterController._pathHistory
              .updateCurrent(Offset(width, height / 2));
          widget.painterController._pathHistory.endCurrent();

          widget.painterController._pathHistory.add(Offset(width / 2, 1));
          widget.painterController._pathHistory
              .updateCurrent(Offset(width / 2, height));
          widget.painterController._pathHistory.endCurrent();
        }
  ...
  void initState() {
    ...
    //   case 'comic':
    //     {
    //       widget.painterController._pathHistory.add(Offset(1, 200));
    //       widget.painterController._pathHistory.updateCurrent(Offset(400, 200));
    //       widget.painterController._pathHistory.endCurrent();

    //       widget.painterController._pathHistory.add(Offset(200, 1));
    //       widget.painterController._pathHistory.updateCurrent(Offset(200, 400));
    //       widget.painterController._pathHistory.endCurrent();
    //     }
    ...
    // widget.painterController._pathHistory.add(
    //   Offset(200, 400),
    // );
    // widget.painterController._pathHistory.updateCurrent(Offset(200, 1));
...
class _PathHistory {
  ...
  // List<MapEntry<Path, Paint>> paa = <MapEntry<Path, Paint>>[];
...
class PainterController extends ChangeNotifier {
  ...
  // PainterController(this.mode);

  /// Creates a new instance for the use in a [Painter] widget.
  PainterController(this.mode) : _pathHistory = new _PathHistory();
